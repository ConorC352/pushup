...
class RentalsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create rental" do
    assert_difference('Rental.count') do
      post rentals_url, params: { rental: { car: @rental.car, days_rented: @rental.days_rented } }
    end
  ...
  test "should update rental" do
    patch rental_url(@rental), params: { rental: { car: @rental.car, days_rented: @rental.days_rented } }
